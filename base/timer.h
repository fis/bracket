 ...
 * wrapper. The scheduling functions of event::Loop tie this to the event loop mechanisms, while
 * desktop::util::Scheduler integrates this class with a GLib main loop.
 *
